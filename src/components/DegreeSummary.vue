              ...
              >
                <div style="height: 100%; margin-top: 46px">
                  <div class="input-group mb-2">
                    <span class="input-group-text categoryNameSpan"
                          style="width: 33%">נקודות תואר</span>
                  ...
                  <div class="input-group mb-2">
                    <span class="input-group-text categoryNameSpan" style="width: 33%">ממוצע תואר</span>
                  ...
                  <div class="input-group mb-2">
                    <span class="input-group-text categoryNameSpan" style="width: 33%">נקודות בוצעו</span>
                    <input class="form-control degree-summary degree-summary-number disabled-input"
                           disabled="disabled"
                           readonly
                           step="0.5"
                  ...
                  <div class="input-group mb-2">
                    <span class="input-group-text categoryNameSpan" style="width: 33%">נקודות נותרו</span>
                    <input class="form-control degree-summary degree-summary-number disabled-input"
                           disabled="disabled"
                           readonly
                           step="0.5"
                  ...
                  <div class="input-group mb-2">
                    <span class="input-group-text categoryNameSpan" style="width: 33%">נותרו לשבץ</span>
                    <input class="form-control degree-summary degree-summary-number disabled-input"
                           disabled="disabled"
                           readonly
                           step="0.5"
              ...
              <b-card class="h-100 shadow bg-white rounded"
                ...
                <template v-for="(type, index) in course_types">
                  <div class="input-group mb-2"
                      ...
                      <span class="input-group-text categoryNameSpan" style="width: 33%">{{type.name}}</span>
                    <input class="input-group-append form-control degree-summary disabled-input"
                           disabled="disabled"
                           readonly
                           step="0.5"
                           type="number"
