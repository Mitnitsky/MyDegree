...
export type UserMutationsTypes<S = UserState> = {
  ...
  [USER_STORE.MUTATIONS.addCourseWithDataToLastSemester](state: S, payload: Course): void
  [USER_STORE.MUTATIONS.addCourseWithDataReturningIndex](state: S, payload): void
  [USER_STORE.MUTATIONS.updateCourse](state: S, { field, value, index }): void
  [USER_STORE.MUTATIONS.swapCourses](state: S, { a, b }): void
  [USER_STORE.MUTATIONS.updateSemesterSummary](state: S, { field, value }): void
  ...
  [USER_STORE.MUTATIONS.changeSemesterType](state: S, semester_number: number): void
  [USER_STORE.MUTATIONS.clearCourse](state: S, index: number): void
  [USER_STORE.MUTATIONS.changeCategoryName](
    state: S,
    name_index: { name: string; index: number }
  ): void
  ...
  [USER_STORE.MUTATIONS.setDegreePointsToChoose](state: S, payload: number): void
}
...
export interface UserActionsTypes {
  ...
  [USER_STORE.ACTIONS.updateSemesterAsync]({ commit }: AugmentedActionContextUser): void
}

export interface StoreActions extends IRootActionsTypes, AuthActionsTypes, UserActionsTypes {}

export interface StoreGetters extends IRootGettersTypes, AuthGettersTypes, UserGettersTypes {}
